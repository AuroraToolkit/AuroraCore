    ...
    func execute() async {
        ...
        var workflow = Workflow(
            ...
            Workflow.Task(
                ...
                return ["articles": Array(articles.prefix(10))]
            }
            ...
            Workflow.Task(
                ...
                let script = try await generateScriptFrom(articleSummaries, llmService: openAIService)
